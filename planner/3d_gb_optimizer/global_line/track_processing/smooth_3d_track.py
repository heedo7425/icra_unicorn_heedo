...
# examples
track_name = 'localization_bridge_2_3d.csv'
track_name_processed = 'localization_bridge_2_3d_smoothed.csv'
...
weights = {
    'w_c': 1e5,  # deviation to measurements centerline
    'w_l': 1e5,  # deviation to measurements left bound
    'w_r': 1e5,  # deviation to measurements right bound
    'w_theta': 1e2,  # smoothness theta
    'w_mu': 1e2,  # smoothness mu
    'w_phi': 1e1,  # smoothness phi
