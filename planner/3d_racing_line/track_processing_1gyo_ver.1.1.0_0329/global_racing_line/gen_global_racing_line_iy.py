...
params = {
    ...
    'track_name': 'localization_bridge_2_3d_smoothed.csv',
    'raceline_name': 'localization_bridge_2_3d_rc_car_timeoptimal_curv_safety_0.1.csv',
    'vehicle_name': 'rc_car_10th',
    'gg_vehicle_name': 'rc_car_10th',  # use rc_car_10th GG diagrams
    'safety_distance': 0.1,  # safety distance to track bounds in m
    ...
    # min curve
    'w_dOmega_z': 1e0,  # cost weight for curvature in road plane (e.g. 1e3)
