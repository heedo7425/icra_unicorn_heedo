...
### Callbacks ###
    ...
    def dyn_param_cb(self, params: Config):
        self.update_waypoints = rospy.get_param("dynamic_prediction_tuner_node/update_waypoints", True)
        self.speed_offset = rospy.get_param("dynamic_prediction_tuner_node/speed_offset")
