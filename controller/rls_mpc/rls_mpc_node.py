...
from rls_mpc.reference_builder import build_preview, extract_frenet_state  # noqa: E402
from rls_mpc.vehicle_model import NU, NX, load_vehicle_params_from_ros  # noqa: E402
...
class RlsMpcNode:
    def __init__(self) -> None:
        ...
        if not self.test_mode:
            try:
                from rls_mpc.mpcc_ocp import build_tracking_ocp  # noqa: E402
    ...
    def _solve(self, x0: np.ndarray, wpnts: np.ndarray) -> Tuple[float, float, float, float, Optional[np.ndarray]]:
        from rls_mpc.mpcc_ocp import solve_once
