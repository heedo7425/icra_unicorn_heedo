...
When the ensemble pickle exists at `/ekf_mpc/gp/ensemble_path`, it uses real
...
class MuEstimatorGP:
    def __init__(self) -> None:
        ...
        self.weights_pub = rospy.Publisher("/ekf_mpc/gp_weights", Float32, queue_size=1)  # publish first weight as summary
