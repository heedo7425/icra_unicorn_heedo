...
from upenn_mpcc.vehicle_model import NX, NU, NP, build_dynamic_bicycle_model  # noqa: E402
...
def build_tracking_ocp_upenn(
    ...
    # Friction circle — MPCC 의 **핵심 speed limiter**. vx_ref 가 없으니 이게
    # 코너 브레이킹을 결정.
    m_val = float(vp["m"])
...
if __name__ == "__main__":
    from upenn_mpcc.vehicle_model import default_vehicle_params
