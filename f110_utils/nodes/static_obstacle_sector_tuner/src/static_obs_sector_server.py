...
from static_obstacle_sector_tuner.cfg import static_obs_dyn_sect_tunerConfig
...
class StaticObstacleSectorPublisher:
    def __init__(self):
        ...
        self.sector_pub = rospy.Publisher('/static_obs_sector_markers', MarkerArray, queue_size=10)
